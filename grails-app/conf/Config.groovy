...
grails.resources.adhoc.patterns = ['/images/*', '/css/*', '/js/*', '/plugins/*','/reports/*']
...
authenticationUserClass = com.smanggin.User
com.grailsrocks.authentication.authenticationUserClass = com.smanggin.User
