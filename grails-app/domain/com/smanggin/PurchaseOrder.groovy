...
//	static	hasOne		= []	// tells GORM to associate another domain object as an owner in a 1-1 mapping
	static	hasMany		= [purchaseOrderDetails:PurchaseOrderDetail, purchaseOrderComments:PurchaseOrderComment]	// tells GORM to associate other domain objects for a 1-n or n-m mapping
