...
<div class="easyui-tabs table" style="height:300px">
        ...
        <div title='<g:message code="pppIndonesia.pppDetails.label" default="Ppp Details" />' style="padding:10px">
            ...
            url:'/${meta(name:'app.name')}/pppDetail/jlist?masterField.name=pppIndonesia&masterField.id=${pppIndonesiaInstance?.id}'">
                <thead>
                    <tr>
        ...
        <r:script>     
            ...
            function pppDetailsAppend(){
                if (pppDetailsEndEditing()){
                    ...
                    {pppIndonesiaId: ${pppIndonesiaInstance.id? pppIndonesiaInstance.id : 0} });
