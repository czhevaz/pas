...
<section id="edit-lob" class="first">
	<div class="row">
		<div class="col-lg-12">
			<div class="box box-primary">
				...
				<g:hasErrors bean="${lobInstance}">
				<div class="alert alert-error">
					<g:renderErrors bean="${lobInstance}" as="list" />
				</div>
				</g:hasErrors>
				...
				<g:form method="post" class="form-horizontal" >
					<div class="box-body">
						...
						<g:hiddenField name="version" value="${lobInstance?.version}" />
