...
<div class="easyui-tabs table" style="height:300px">
        ...
        <div title='<g:message code="pppCambodia.pppDetails.label" default="Ppp Details" />' style="padding:10px">
            ...
            url:'/${meta(name:'app.name')}/pppDetail/jlist?masterField.name=pppCambodia&masterField.id=${pppCambodiaInstance?.id}'">
                <thead>
                    <tr>
        ...
        <r:script>     
            ...
            function pppDetailsAppend(){
                if (pppDetailsEndEditing()){
                    ...
                    {pppCambodiaId: ${pppCambodiaInstance.id? pppCambodiaInstance.id : 0} });
