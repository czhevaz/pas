...
<div class="easyui-tabs table" style="height:300px">
        ...
        <div title='<g:message code="pppSouthAfrica.pppDetails.label" default="Ppp Details" />' style="padding:10px">
            ...
            url:'/${meta(name:'app.name')}/pppDetail/jlist?masterField.name=pppSouthAfrica&masterField.id=${pppSouthAfricaInstance?.id}'">
                <thead>
                    <tr>
        ...
        <r:script>     
            ...
            function pppDetailsAppend(){
                if (pppDetailsEndEditing()){
                    ...
                    {pppSouthAfricaId: ${pppSouthAfricaInstance.id? pppSouthAfricaInstance.id : 0} });
