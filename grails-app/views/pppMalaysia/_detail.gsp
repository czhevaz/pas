...
<div class="easyui-tabs table" style="height:300px">
        ...
        <div title='<g:message code="pppMalaysia.pppDetails.label" default="Ppp Details" />' style="padding:10px">
            ...
            url:'/${meta(name:'app.name')}/pppDetail/jlist?masterField.name=pppMalaysia&masterField.id=${pppMalaysiaInstance?.id}'">
                <thead>
                    <tr>
        ...
        <r:script>     
            ...
            function pppDetailsAppend(){
                if (pppDetailsEndEditing()){
                    ...
                    {pppMalaysiaId: ${pppMalaysiaInstance.id? pppMalaysiaInstance.id : 0} });
