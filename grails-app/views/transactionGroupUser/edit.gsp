...
<section id="edit-transactionGroupUser" class="first">
	<div class="row">
		<div class="col-lg-12">
			<div class="box box-primary">
				...
				<g:form method="post" class="form-horizontal" >
					<div class="box-body">
						<g:hiddenField name="id" value="${transactionGroupUserInstance?.id}" />
						<g:hiddenField name="version" value="${transactionGroupUserInstance?.version}" />
