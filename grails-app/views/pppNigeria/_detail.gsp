...
<div class="easyui-tabs table" style="height:300px">
        ...
        <div title='<g:message code="pppNigeria.pppDetails.label" default="Ppp Details" />' style="padding:10px">
            ...
            url:'/${meta(name:'app.name')}/pppDetail/jlist?masterField.name=pppNigeria&masterField.id=${pppNigeriaInstance?.id}'">
                <thead>
                    <tr>
        ...
        <r:script>     
            ...
            function pppDetailsAppend(){
                if (pppDetailsEndEditing()){
                    ...
                    {pppNigeriaId: ${pppNigeriaInstance.id? pppNigeriaInstance.id : 0} });
