...
<div class="easyui-tabs table" style="height:300px">
        ...
        <div title='<g:message code="pppMyanmar.pppDetails.label" default="Ppp Details" />' style="padding:10px">
            ...
            url:'/${meta(name:'app.name')}/pppDetail/jlist?masterField.name=pppMyanmar&masterField.id=${pppMyanmarInstance?.id}'">
                <thead>
                    <tr>
        ...
        <r:script>     
            ...
            function pppDetailsAppend(){
                if (pppDetailsEndEditing()){
                    ...
                    {pppMyanmarId: ${pppMyanmarInstance.id? pppMyanmarInstance.id : 0} });
