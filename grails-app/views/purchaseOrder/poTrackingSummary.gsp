							...
							<div class="col-sm-6">
								...
								<div class="form-group ${hasErrors(bean: purchaseOrderInstance, field: 'country', 'error')}  required">
									...
									<!--	<p class="form-control-static">${session.country}</p>	
										...
										<g:select id="country" name="country" from="${countryList}" optionKey="name" required="" value="${purchaseOrderInstance?.country}" class="many-to-one form-control chosen-select" />
