...
<div class="easyui-tabs table" style="height:300px">
        ...
        <div title='<g:message code="pppSrilanka.pppDetails.label" default="Ppp Details" />' style="padding:10px">
            ...
            url:'/${meta(name:'app.name')}/pppDetail/jlist?masterField.name=pppSrilanka&masterField.id=${pppSrilankaInstance?.id}'">
                <thead>
                    <tr>
        ...
        <r:script>     
            ...
            function pppDetailsAppend(){
                if (pppDetailsEndEditing()){
                    ...
                    {pppSrilankaId: ${pppSrilankaInstance.id? pppSrilankaInstance.id : 0} });
