...
<div class="easyui-tabs table" style="height:300px">
        ...
        <div title='<g:message code="pppSingapore.pppDetails.label" default="Ppp Details" />' style="padding:10px">
            ...
            url:'/${meta(name:'app.name')}/pppDetail/jlist?masterField.name=pppSingapore&masterField.id=${pppSingaporeInstance?.id}'">
                <thead>
                    <tr>
        ...
        <r:script>     
            ...
            function pppDetailsAppend(){
                if (pppDetailsEndEditing()){
                    ...
                    {pppSingaporeId: ${pppSingaporeInstance.id? pppSingaporeInstance.id : 0} });
